...
public class Statistics  extends AppCompatActivity {
    ...
    public void GraphInitSetting(){
        switch(today){
            case 0:
                daylabelList.add("월");daylabelList.add("화");daylabelList.add("수");daylabelList.add("목");daylabelList.add("금");daylabelList.add("토");daylabelList.add("일");
                break;
            case 1:
                daylabelList.add("화");daylabelList.add("수");daylabelList.add("목");daylabelList.add("금");daylabelList.add("토");daylabelList.add("일");daylabelList.add("월");
                break;
            case 2:
                daylabelList.add("수");daylabelList.add("목");daylabelList.add("금");daylabelList.add("토");daylabelList.add("일");daylabelList.add("월");daylabelList.add("화");
                break;
            case 3:
                daylabelList.add("목");daylabelList.add("금");daylabelList.add("토");daylabelList.add("일");daylabelList.add("월");daylabelList.add("화");daylabelList.add("수");
                break;
            case 4:
                daylabelList.add("금");daylabelList.add("토");daylabelList.add("일");daylabelList.add("월");daylabelList.add("화");daylabelList.add("수");daylabelList.add("목");
                break;
            case 5:
                daylabelList.add("토");daylabelList.add("일");daylabelList.add("월");daylabelList.add("화");daylabelList.add("수");daylabelList.add("목");daylabelList.add("금");
                break;
            case 6:
        ...
        dayjsonList.add(OneDayCnt);dayjsonList.add(TwoDayCnt);dayjsonList.add(ThreeDayCnt);
        dayjsonList.add(FourDayCnt);dayjsonList.add(FiveDayCnt);dayjsonList.add(SixDayCnt);dayjsonList.add(TodayCnt);

        findMaxCntDay(OneDayCnt, TwoDayCnt, ThreeDayCnt, FourDayCnt, FiveDayCnt, SixDayCnt, TodayCnt);

        timejsonList.add(midnightCnt);timejsonList.add(time1);timejsonList.add(time2);timejsonList.add(time3);timejsonList.add(time4);timejsonList.add(time5);
        timejsonList.add(time6);timejsonList.add(time7);timejsonList.add(time8);timejsonList.add(time9);timejsonList.add(time10);timejsonList.add(time11);
        timejsonList.add(noonCnt);timejsonList.add(time13);timejsonList.add(time14);timejsonList.add(time15);timejsonList.add(time16);timejsonList.add(time17);
        timejsonList.add(time18);timejsonList.add(time19);timejsonList.add(time20);timejsonList.add(time21);timejsonList.add(time22);timejsonList.add(time23);
    ...
    public void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                if((7 + today - ItDate.getDay())%7 == 6) { OneDayCnt += 1; }
                else if((7 + today - ItDate.getDay())%7 == 5) { TwoDayCnt += 1; }
                else if((7 + today - ItDate.getDay())%7 == 4) { ThreeDayCnt += 1; }
                else if((7 + today - ItDate.getDay())%7 == 3) { FourDayCnt += 1; }
                else if((7 + today - ItDate.getDay())%7 == 2) { FiveDayCnt += 1; }
                else if((7 + today - ItDate.getDay())%7 == 1) { SixDayCnt += 1; }
                else if((7 + today - ItDate.getDay())%7 == 0)
                {
                    TodayCnt += 1;
                    if(ItDate.getHours() == 0){midnightCnt+=1;}
                    else if(ItDate.getHours() == 1){time1+=1;}
                    else if(ItDate.getHours() == 2){time2+=1;}
                    else if(ItDate.getHours() == 3){time3+=1;}
                    else if(ItDate.getHours() == 4){time4+=1;}
                    else if(ItDate.getHours() == 5){time5+=1;}
                    else if(ItDate.getHours() == 6){time6+=1;}
                    else if(ItDate.getHours() == 7){time7+=1;}
                    else if(ItDate.getHours() == 8){time8+=1;}
                    else if(ItDate.getHours() == 9){time9+=1;}
                    else if(ItDate.getHours() == 10){time10+=1;}
                    else if(ItDate.getHours() == 11){time11+=1;}
                    else if(ItDate.getHours() == 12){noonCnt+=1;}
                    else if(ItDate.getHours() == 13){time13+=1;}
                    else if(ItDate.getHours() == 14){time14+=1;}
                    else if(ItDate.getHours() == 15){time15+=1;}
                    else if(ItDate.getHours() == 16){time16+=1;}
                    else if(ItDate.getHours() == 17){time17+=1;}
                    else if(ItDate.getHours() == 18){time18+=1;}
                    else if(ItDate.getHours() == 19){time19+=1;}
                    else if(ItDate.getHours() == 20){time20+=1;}
                    else if(ItDate.getHours() == 21){time21+=1;}
                    else if(ItDate.getHours() == 22){time22+=1;}
                    else if(ItDate.getHours() == 23){time23+=1;}
                }
            }
            GraphInitSetting(); // 그래프 세팅
    ...
    public int findMaxCntDay(int oneDayCnt, int twoDayCnt, int threeDayCnt, int fourDayCnt, int fiveDayCnt, int sixDayCnt, int todayCnt){
        ...
        for(int i = 0; i < CntArr.length; i++) {
            if(MaxCntDay<CntArr[i]) { MaxCntDay = CntArr[i]; }
        }
    ...
    public int findMaxCntTime(int time1, int time2, int time3, int time4, int time5, int time6, int time7, int time8, int time9, int time10, int time11, int time12){
        ...
        for(int i = 0; i < CntArr.length; i++) {
            if(MaxCntTime < CntArr[i]) { MaxCntTime = CntArr[i]; }
        }
